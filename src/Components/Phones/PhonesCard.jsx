...
const PhonesCard = ({ phone }) => {
    ...
    const { id, phone_name, brand_name, image, rating, price } = phone || {};
        ...
        <div>
            <div className="relative flex w-96 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
                ...
                <div className="p-6">
                    ...
                    <p className="block font-sans text-sm font-normal leading-normal text-red-500 antialiased opacity-75">
                        <Rating emptySymbol={<svg
